...
{
    // Register this entity in the DbContext using the "public DbSet<ReportingArtifact> ReportingArtifacts { get; set; }" syntax.
    [DefaultClassOptions]
    ...
    public class InformationProduct : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public InformationProduct()
        {
            ...
            this.AssociatedAnalyticalMethods = new List<AnalyticalMethod>();
        }
        ...
        public virtual IList<AnalyticalMethod> AssociatedAnalyticalMethods { get; set; }
    }
}
