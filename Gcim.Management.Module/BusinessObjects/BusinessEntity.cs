...
{
    // Register this entity in the DbContext using the "public DbSet<BusinessEntity> BusinessEntitys { get; set; }" syntax.
    [DefaultClassOptions]
    ...
    public class BusinessEntity : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
