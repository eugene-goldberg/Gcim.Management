...
{
    // Register this entity in the DbContext using the "public DbSet<BusinessInitiative> BusinessInitiatives { get; set; }" syntax.
    [DefaultClassOptions]
   
    public class BusinessInitiative : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
