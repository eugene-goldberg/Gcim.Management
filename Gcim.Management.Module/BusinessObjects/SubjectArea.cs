...
{
    // Register this entity in the DbContext using the "public DbSet<SubjectArea> SubjectAreas { get; set; }" syntax.
    [DefaultClassOptions]
    
    public class SubjectArea : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public SubjectArea()
        {
