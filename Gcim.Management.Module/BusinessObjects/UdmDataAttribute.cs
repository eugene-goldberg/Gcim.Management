...
{
    // Register this entity in the DbContext using the "public DbSet<UdmDataAttribute> UdmDataAttributes { get; set; }" syntax.
    [DefaultClassOptions]
    ...
    public class UdmDataAttribute : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
