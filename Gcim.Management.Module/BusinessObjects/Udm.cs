...
{
    // Register this entity in the DbContext using the "public DbSet<Udm> Udms { get; set; }" syntax.
    [DefaultClassOptions]
   
    public class Udm : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public Udm()
        {
