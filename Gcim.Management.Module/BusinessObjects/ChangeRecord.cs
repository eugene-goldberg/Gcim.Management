...
{
    // Register this entity in the DbContext using the "public DbSet<ChangeRecord> ChangeRecords { get; set; }" syntax.
    [DefaultClassOptions]
    ...
    public class ChangeRecord : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public ChangeRecord()
        {
