...
{
    // Register this entity in the DbContext using the "public DbSet<AnalyticalMethod> AnalyticalMethods { get; set; }" syntax.
    [DefaultClassOptions]
   
    public class AnalyticalMethod : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
